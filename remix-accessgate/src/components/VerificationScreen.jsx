  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-6 sm:py-10" role="main">
      ...
      <section
        ...
        className="bg-white border-2 border-[#E8DDC7] rounded-3xl p-6 sm:p-10 shadow-sm relative overflow-hidden card-rhythm-texture"
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-[#54192B] to-[#3E1220] border-2 border-[#C9962F] flex items-center justify-center shadow-md">
              <IconBrandShield className="w-7 h-7 text-[#C9962F]" aria-hidden="true" />
            </div>
            <div>
              <h1
                id="welcome-heading"
              ...
              <p className="text-xl sm:text-2xl font-bold text-[#C9962F] mt-0.5 tracking-tight">
                Accessible verification for everyone
              </p>
            </div>
          </div>

          <p className="text-sm sm:text-base text-stone-700 mt-5 max-w-2xl leading-relaxed">
      ...
      <section className="mt-8 sm:mt-10" aria-labelledby="features-heading">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
          ...
          <button
            ...
            className="bg-white border-2 border-[#E8DDC7] rounded-2xl p-5 sm:p-6 shadow-2xs hover:border-[#C9962F] hover:shadow-md hover:-translate-y-1 transition-all flex flex-col justify-between text-left cursor-pointer group focus-visible:ring-4 focus-visible:ring-[#C9962F] card-rhythm-texture"
            aria-label="Start Haptic Rhythm Verification directly"
          >
            <div>
              <div className="w-12 h-12 rounded-2xl art-icon-badge flex items-center justify-center mb-4 group-hover:scale-105 transition-transform">
                <IconHapticRhythm className="w-7 h-7 text-[#C9962F]" aria-hidden="true" />
              </div>
          ...
          >
            <div>
              <div className="w-12 h-12 rounded-2xl art-icon-badge flex items-center justify-center mb-4 group-hover:scale-105 transition-transform">
                <IconBehavioralJitter className="w-7 h-7 text-[#C9962F]" aria-hidden="true" />
              </div>
              <span className="text-[11px] font-bold text-[#C9962F] uppercase tracking-wider block">
                Layer 2
              </span>
          ...
          >
            <div>
              <div className="w-12 h-12 rounded-2xl art-icon-badge flex items-center justify-center mb-4 group-hover:scale-105 transition-transform">
                <IconAcousticVoice className="w-7 h-7 text-[#C9962F]" aria-hidden="true" />
              </div>
              <span className="text-[11px] font-bold text-[#C9962F] uppercase tracking-wider block">
                Layer 3
              </span>
