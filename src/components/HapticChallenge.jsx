...
export default function HapticChallenge({
  ...
  const handleTapsCompleted = (tapTimestamps) => {
    ...
    voiceAnnounce('Analyzing tap timing...');

    // Small delay to simulate evaluation and behavioral biometric processing
    setTimeout(() => {
      ...
      <div className="bg-white border-2 border-[#E8DDC7] rounded-2xl shadow-sm p-5 sm:p-8">
        ...
        >
          ...
          {challengeState === 'playing' && (
            <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-[#C9962F] text-[#3E1220] text-xs font-bold animate-pulse">
              Playing pulses...
            </span>
          )}
        </div>
        ...
        <div className="flex flex-col items-center justify-center py-4">
          {challengeState === 'idle' ? (
            <div className="text-center space-y-4 max-w-md">
              <div className="w-16 h-16 rounded-2xl bg-[#3E1220] text-[#C9962F] flex items-center justify-center mx-auto shadow-md">
              ...
              <button
                ...
                className="w-full py-3.5 px-6 rounded-xl bg-[#C9962F] hover:bg-[#b58525] text-[#3E1220] font-black text-base shadow-md transition-transform active:scale-98 flex items-center justify-center gap-2"
            ...
            <div className="text-center py-8 space-y-4">
              <div className="relative w-24 h-24 mx-auto flex items-center justify-center">
                <div className="absolute inset-0 rounded-full bg-[#C9962F]/30 animate-ping" />
                <div className="w-20 h-20 rounded-full bg-[#3E1220] text-[#C9962F] flex items-center justify-center relative shadow-lg">
            ...
            <div className="w-full">
              ...
              <div className="mt-8 pt-5 border-t border-[#E8DDC7] flex flex-wrap items-center justify-between gap-3 text-xs">
                <button
                  type="button"
                  onClick={handlePlayPattern}
                  className="px-4 py-2 rounded-xl border border-[#3E1220] text-[#3E1220] font-bold hover:bg-[#3E1220]/5 flex items-center gap-1.5 transition-colors"
                ...
                <button
                  ...
                  className="px-3 py-2 text-stone-600 hover:text-[#3E1220] font-semibold"
                >
