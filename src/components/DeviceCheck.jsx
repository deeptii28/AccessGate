...
export default function DeviceCheck({
  ...
  if (checking || !capabilities) {
    return (
      <div className="max-w-2xl mx-auto px-4 py-12 text-center" aria-live="polite">
        <div className="w-12 h-12 border-4 border-[#C9962F] border-t-transparent rounded-full animate-spin mx-auto mb-4" />
        <h2 className="text-lg font-bold text-[#3E1220]">Analyzing Browser Capabilities...</h2>
      ...
      <div className="bg-white border-2 border-[#E8DDC7] rounded-2xl shadow-sm p-5 sm:p-8">
        ...
        <div className="border-b border-[#E8DDC7] pb-5 mb-6">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#3E1220]/5 text-[#3E1220] text-xs font-bold uppercase tracking-wider mb-2">
            <Smartphone className="w-4 h-4 text-[#C9962F]" aria-hidden="true" />
            Layer 0 Diagnostic
          </div>
